...
const testData = [
  ...
  },
  {
    ...
    expected: {
      message:
        "'doSomething' requires an arguments object as the first argument.",
    },
  },
  {
    ...
    expected: {
      message:
        "Error loading policy: 'doSomething' is not a valid service name.",
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      message:
        "Loading 'doSomething': No resolution for dependency 'helpDoSomething' of type 'service'.",
    },
  },
  {
    ...
    expected: {
      message:
        "Loading 'doSomething': No resolution for dependencyType 'service'.",
    },
  },
]
